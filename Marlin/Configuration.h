 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 62, 5, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
// Suppress warning about DIAG jumpers when SENSORLESS_HOMING is disabled
